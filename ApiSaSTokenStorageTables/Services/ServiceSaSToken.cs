...
namespace ApiSaSTokenStorageTables.Services
{
    ...
    {
        //ESTA CLASE GENERARÁ TOKENS A PARTIR DE LA TABLA ALUMNOS
...
            TableSasPermissions permisos =
            ...
            TableSasBuilder builder =
                 this.tablaAlumnos.GetSasBuilder
                 (permisos, DateTime.Now.AddMinutes(50));
            //QUEREMOS QUE SOLAMENTE NOS MUESTRE LOS CURSOS
            //(PARTITIONKEY)



            //EJ: SI QUISIERA LOS DEL CURSO DE JAVA SERIA:
            // builder.PartitionKeyStart = "JAVA";
            // builder.PartitionKeyEnd = "JAVA";
